...
const HomeScreen = ({navigation}) => {
    ...
    useEffect(() => {
      ...
      const attendCard = () => {
        if(attendance === "Present"){
            return(
                <Card style={styles.cardfst2} onPress={() => navigation.navigate('Subscription')}>
                    <Card.Content>
                    <Image style={{height:25, width:25, alignSelf:'flex-end',}} source={require('../icons/attendance.png')}/>
                        <Text style={{color:'black', fontSize:12, marginTop:15}}>Attendance</Text>
                        <Text style={{color:'black', fontWeight:'bold', fontSize:35, marginTop:-5,}}>{attendance}</Text>
                        <Text style={{color:'black', fontSize:10, marginTop:40,}}>08/02/2023</Text>
      ...
      const attendBtn = () => {
        if(attendance === "Present"){
            ...
            return(
                <Card style={styles.cardsec} onPress={() => setAttendance("Present")}>
                <Card.Content>

                <Text style={{color:'white', fontWeight:'bold', fontSize:20, marginTop:-5,}}>Mark Present</Text>
                </Card.Content>
                </Card>
            );
        }
    ...
    return (
        <ScrollView>
            ...
            <Text h5 style={{marginTop: 10, marginLeft:10, fontWeight:'bold', color: 'gray', }}>{company}</Text>
            ...
            <Image style={{height:250, width:350, marginTop:30, borderRadius:30, marginLeft:20}} source={require('../assets/attedanceChart.png')}/>
